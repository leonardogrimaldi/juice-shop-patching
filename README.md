...
[![DOI](https://zenodo.org/badge/1109222585.svg)](https://doi.org/10.5281/zenodo.18661515)

This repository contains the work for my [thesis](https://github.com/leonardogrimaldi/thesis-bachelor). It includes some **vulnerability patches** for the application, for more info consult the releases page and/or the thesis.
